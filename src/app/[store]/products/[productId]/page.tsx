  ...
  return <div>
      ...
      <nav className="mb-4 text-sm">
        <ol className="inline-flex list-none p-0">
          <li className="flex items-center">
            ...
            <svg className="mx-3 h-3 w-3 fill-current text-gray-300" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <div className="md:w-1/2">
          <div className="relative w-full overflow-hidden rounded-3xl bg-gray-200 h-96 border-red-600 border z-50"></div>
