  ...
  return (
    <div>
      <section className="bg-primary px-2 pt-20 ">
        ...
        <div className="relative flex justify-between items-center h-[300px] bg-[#f0e7d5]  py-10 px-5 mb-8">
          {/* Free Shipping */}
          <div className="flex flex-col items-center text-center">
            <FaShippingFast className="text-6xl mb-4"/>
            <h1 className="text-black text-[40px] font-bold uppercase tracking-wide">{t('Shipping')}</h1>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-black text-[40px] font-bold uppercase tracking-wide">{t('Return')} </h1>
            <div className="w-[60px] h-[3px] bg-black mt-2 mb-4"></div> {/* This is for the underline element */}
            <p className="text-[16px] leading-[1.8] tracking-[0.005rem] text-gray-700">
              {t('ReturnDescription')}
            </p> 
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-black text-[40px] font-bold uppercase tracking-wide">{t('Warranty')}</h1>
            <div className="w-[60px] h-[3px] bg-black mt-2 mb-4"></div> {/* This is for the underline element */}
            <p className="text-[16px] leading-[1.8] tracking-[0.005rem] text-gray-700">
