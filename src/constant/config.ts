...
export const categories: Array<Category> = [
  {
    ...
    subtitle:
      'Découvrez notre ensemble exclusif de 3 valises avec roues fixes, l’ultime compagnon de voyage pour ceux qui recherchent à la fois la fonctionnalité et l’élégance. Chaque valise de cet ensemble est méticuleusement conçue pour offrir une expérience de voyage sans tracas.',
    price: 199.99,
    currency: '$',
    rating: 4.64,
    sizes: [],
    ...
    colors: [
      {
        color: 'Bleu Turquoise',
        code: '#40E0D0',
        images: ['/images/Mat/Bleu Turquoise/1.jpg']
      },
      {
        color: "Vert d'eau",
        code: '#00FF7F',
        images: ["/images/Mat/Vert d'eau/1.jpg"]
      }
    ],
    subtitle:
      'Découvrez notre ensemble exclusif de 3 valises avec roues fixes, l’ultime compagnon de voyage pour ceux qui recherchent à la fois la fonctionnalité et l’élégance. Chaque valise de cet ensemble est méticuleusement conçue pour offrir une expérience de voyage sans tracas.',
